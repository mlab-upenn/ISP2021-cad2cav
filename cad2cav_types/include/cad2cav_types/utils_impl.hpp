#ifndef __CAD2CAV_TYPES_UTILS_IMPL_HPP__
#define __CAD2CAV_TYPES_UTILS_IMPL_HPP__
...
cad2cav::Graph fromUserGraph(const GraphType &user_graph, bool switch_xy) {
  cad2cav::Graph graph;
...
#endif /* __CAD2CAV_TYPES_UTILS_IMPL_HPP__ */
