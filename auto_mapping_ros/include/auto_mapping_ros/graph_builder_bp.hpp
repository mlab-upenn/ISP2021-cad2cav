 ...
 * @brief A wrapper for graph builder which reads from CAD blueprint screenshot
 * & unreal waypoints
 * @date 2021-03-15
 *
 ...
 *  This class reads map from Autodesk Viewer screenshots & waypoints from
 * building UE4 models. For details of UE4 building model construction see
...
private:
   ...
   * @param userData
   */
  static void calibrateMapMouseCallback(int event, int x, int y, int flags,
                                        void* userData);
