...
// For some weird reasons OSQP must be included after OpenCV. Otherwise there
...
private:
  ...
  std::string
      local_planning_mode_;  // "pure_pursuit" or "mpc". Default to "mpc".

  std::vector<PlannerNode> transform(
