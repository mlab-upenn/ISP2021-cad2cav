...
// Manages occupancy grid using a boolean Eigen Matrix
...
public:
  ...
  void FillOccGrid(const geometry_msgs::Pose &pose_msg,
  ...
  bool CheckCollision(std::pair<float, float> first_point,
