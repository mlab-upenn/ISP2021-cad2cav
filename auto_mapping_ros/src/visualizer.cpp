...
std::vector<std_msgs::ColorRGBA> Visualizer::GenerateVizColors(std::vector<std::pair<float, float>> &points,
...
visualization_msgs::Marker Visualizer::GenerateList(std::vector<geometry_msgs::Point> &marker_points,
                                                    std::vector<std_msgs::ColorRGBA> &marker_colors,
                                                    int type, double scale_x, double scale_y, double scale_z) {
...
visualization_msgs::Marker Visualizer::GenerateList(std::vector<std::pair<float, float>> &points,
                                                    std::vector<std_msgs::ColorRGBA> &marker_colors,
                                                    int type, double scale_x, double scale_y, double scale_z) {
...
visualization_msgs::Marker Visualizer::GenerateSphereList(std::vector<std::pair<float, float>> &points,
                                                          float r, float g, float b) {
