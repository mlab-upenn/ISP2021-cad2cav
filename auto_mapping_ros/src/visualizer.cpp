...
std::vector<geometry_msgs::Point> Visualizer::GenerateVizPoints(
...
std::vector<std_msgs::ColorRGBA> Visualizer::GenerateVizColors(
    std::vector<std::pair<float, float>> &points, float r, float g, float b) {
...
visualization_msgs::Marker Visualizer::GenerateList(
    std::vector<geometry_msgs::Point> &marker_points,
    std::vector<std_msgs::ColorRGBA> &marker_colors, int type, double scale_x,
...
visualization_msgs::Marker Visualizer::GenerateSphereList(
    std::vector<std::pair<float, float>> &points, float r, float g, float b) {
...
visualization_msgs::Marker Visualizer::GenerateSphereList(
  ...
  return GenerateList(points, marker_colors,
