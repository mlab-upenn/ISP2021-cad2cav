...
class ConstraintSolverParameters PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_ortools_2fconstraint_5fsolver_2fsolver_5fparameters_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void ConstraintSolverParameters::_internal_set_profile_file(const std::string& value) {
  ...
  profile_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void ConstraintSolverParameters::set_profile_file(const char* value) {
  ...
  profile_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:operations_research.ConstraintSolverParameters.profile_file)
}
inline void ConstraintSolverParameters::set_profile_file(const char* value,
    size_t size) {
  
  profile_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* ConstraintSolverParameters::_internal_mutable_profile_file() {
  ...
  return profile_file_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
