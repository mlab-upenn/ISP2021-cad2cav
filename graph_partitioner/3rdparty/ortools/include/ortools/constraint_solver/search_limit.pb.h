...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_ortools_2fconstraint_5fsolver_2fsearch_5flimit_2eproto_metadata_getter(int index);
...
class RegularLimitParameters PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_ortools_2fconstraint_5fsolver_2fsearch_5flimit_2eproto_metadata_getter(kIndexInFileMessages);
  }
