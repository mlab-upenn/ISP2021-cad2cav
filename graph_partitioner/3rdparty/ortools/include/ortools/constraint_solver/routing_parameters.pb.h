...
class RoutingSearchParameters_LocalSearchNeighborhoodOperators PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class RoutingSearchParameters_ImprovementSearchLimitParameters PROTOBUF_FINAL :
 ...
 public:
  ...
  inline RoutingSearchParameters_ImprovementSearchLimitParameters* New() const final {
    return CreateMaybeMessage<RoutingSearchParameters_ImprovementSearchLimitParameters>(nullptr);
  }
...
inline void RoutingSearchParameters::clear_improvement_limit_parameters() {
  if (GetArena() == nullptr && improvement_limit_parameters_ != nullptr) {
...
inline ::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* RoutingSearchParameters::mutable_improvement_limit_parameters() {
  ...
  return _internal_mutable_improvement_limit_parameters();
}
inline void RoutingSearchParameters::set_allocated_improvement_limit_parameters(::operations_research::RoutingSearchParameters_ImprovementSearchLimitParameters* improvement_limit_parameters) {
  ...
  if (improvement_limit_parameters) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(improvement_limit_parameters);
    if (message_arena != submessage_arena) {
...
inline void RoutingSearchParameters::_internal_set_log_tag(const std::string& value) {
  ...
  log_tag_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void RoutingSearchParameters::set_log_tag(const char* value) {
  ...
  log_tag_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:operations_research.RoutingSearchParameters.log_tag)
}
inline void RoutingSearchParameters::set_log_tag(const char* value,
    size_t size) {
  
  log_tag_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* RoutingSearchParameters::_internal_mutable_log_tag() {
  ...
  return log_tag_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
