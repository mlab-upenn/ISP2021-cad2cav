...
class BopOptimizerMethod PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_ortools_2fbop_2fbop_5fparameters_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void BopParameters::clear_default_solver_optimizer_sets() {
  default_solver_optimizer_sets_.ClearToDefault(::operations_research::bop::BopParameters::_i_give_permission_to_break_this_code_default_default_solver_optimizer_sets_, GetArena());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void BopParameters::_internal_set_default_solver_optimizer_sets(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  default_solver_optimizer_sets_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
...
inline void BopParameters::set_default_solver_optimizer_sets(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  default_solver_optimizer_sets_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:operations_research.bop.BopParameters.default_solver_optimizer_sets)
}
inline void BopParameters::set_default_solver_optimizer_sets(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  default_solver_optimizer_sets_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, ::std::string(
...
inline std::string* BopParameters::_internal_mutable_default_solver_optimizer_sets() {
  _has_bits_[0] |= 0x00000001u;
  return default_solver_optimizer_sets_.Mutable(::operations_research::bop::BopParameters::_i_give_permission_to_break_this_code_default_default_solver_optimizer_sets_, GetArena());
}
inline std::string* BopParameters::release_default_solver_optimizer_sets() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return default_solver_optimizer_sets_.ReleaseNonDefault(nullptr, GetArena());
}
