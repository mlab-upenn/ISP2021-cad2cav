...
class Machine final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::operations_research::data::jssp::TransitionTimeMatrix* release_transition_time_matrix();
...
inline ::operations_research::data::jssp::Task* Job::add_tasks() {
  ::operations_research::data::jssp::Task* _add = _internal_add_tasks();
...
inline ::operations_research::data::jssp::TransitionTimeMatrix* Machine::_internal_mutable_transition_time_matrix() {
  ...
  if (transition_time_matrix_ == nullptr) {
    auto* p = CreateMaybeMessage<::operations_research::data::jssp::TransitionTimeMatrix>(GetArenaForAllocation());
...
inline ::operations_research::data::jssp::TransitionTimeMatrix* Machine::mutable_transition_time_matrix() {
  ::operations_research::data::jssp::TransitionTimeMatrix* _msg = _internal_mutable_transition_time_matrix();
...
inline void Machine::set_allocated_transition_time_matrix(::operations_research::data::jssp::TransitionTimeMatrix* transition_time_matrix) {
  ...
  if (transition_time_matrix) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::data::jssp::TransitionTimeMatrix>::GetOwningArena(transition_time_matrix);
    if (message_arena != submessage_arena) {
...
inline ::operations_research::data::jssp::Job* JsspInputProblem::add_jobs() {
  ::operations_research::data::jssp::Job* _add = _internal_add_jobs();
...
inline ::operations_research::data::jssp::Machine* JsspInputProblem::add_machines() {
  ::operations_research::data::jssp::Machine* _add = _internal_add_machines();
...
inline ::operations_research::data::jssp::JobPrecedence* JsspInputProblem::add_precedences() {
  ::operations_research::data::jssp::JobPrecedence* _add = _internal_add_precedences();
...
inline ::operations_research::data::jssp::AssignedTask* AssignedJob::add_tasks() {
  ::operations_research::data::jssp::AssignedTask* _add = _internal_add_tasks();
...
inline ::operations_research::data::jssp::AssignedJob* JsspOutputSolution::add_jobs() {
  ::operations_research::data::jssp::AssignedJob* _add = _internal_add_jobs();
