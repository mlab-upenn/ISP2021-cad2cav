...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_ortools_2fdata_2frcpsp_2eproto_metadata_getter(int index);
...
class Resource PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_ortools_2fdata_2frcpsp_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void RcpspProblem::_internal_set_basedata(const std::string& value) {
  ...
  basedata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void RcpspProblem::set_basedata(const char* value) {
  ...
  basedata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:operations_research.data.rcpsp.RcpspProblem.basedata)
}
inline void RcpspProblem::set_basedata(const char* value,
    size_t size) {
  
  basedata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* RcpspProblem::_internal_mutable_basedata() {
  ...
  return basedata_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
