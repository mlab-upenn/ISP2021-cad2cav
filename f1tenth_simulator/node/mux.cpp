...
public:
  Mux() {
    ...
    // A channel contains a subscriber to the given drive topic and a publisher
    // to the main drive topic
...
Channel::Channel(std::string channel_name, std::string drive_topic,
  ...
  drive_pub =
      mux->n.advertise<ackermann_msgs::AckermannDriveStamped>(drive_topic, 10);
  channel_sub =
